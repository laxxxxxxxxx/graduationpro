...
('正念冥想入门指南', 2, 2, '/uploads/images/mindfulness-guide-cover.png', '/uploads/videos/mindfulness.mp4', 600, 1, '正念,冥想,放松,减压', '冥想导师B', '合作', 1, 280, 89, 1, NOW()),
...
('情绪管理ABC理论', 2, 1, '/uploads/images/emotion-abc-cover.png', '/uploads/videos/emotion_abc.mp4', 900, 2, '情绪管理,认知疗法,ABC理论', '心理学专家E', '合作', 1, 410, 125, 1, NOW()),
('睡眠改善实用方法', 1, 2, '/uploads/images/sleep-improvement-cover.png', '<p>良好的睡眠对心理健康的影响...</p>', NULL, 1, '睡眠,健康,生活习惯', '睡眠专家F', '原创', 1, 190, 56, 1, NOW()),
('抑郁情绪的识别与应对', 2, 1, '/uploads/images/depression-coping-cover.png', '/uploads/videos/breathing.mp4', 1200, 3, '抑郁,情绪识别,自我调节', '临床心理学家G', '合作', 1, 520, 178, 1, NOW()),
('时间管理与学习效率', 1, 4, '/uploads/images/time-management-cover.png', '<p>如何合理安排时间提高学习效率...</p>', NULL, 1, '时间管理,学习效率,自律', '学习顾问H', '原创', 1, 240, 72, 1, NOW()),
('恋爱心理学基础', 2, 3, '/uploads/images/love-psychology-cover.png', '/uploads/videos/mindfulness.mp4', 1500, 2, '恋爱,情感,亲密关系', '情感咨询师I', '合作', 1, 680, 234, 1, NOW()),
('压力下的自我关怀', 1, 2, '/uploads/images/self-care-cover.png', '<p>在压力下如何照顾好自己...</p>', NULL, 1, '自我关怀,压力应对,心理健康', '心理咨询师J', '原创', 1, 175, 51, 1, NOW()),
('社交恐惧的克服方法', 2, 3, '/uploads/images/social-anxiety-cover.png', '/uploads/videos/breathing.mp4', 1000, 2, '社交恐惧,焦虑,暴露疗法', '心理治疗师K', '合作', 1, 390, 115, 1, NOW()),
...
((SELECT id FROM education_resource WHERE title='睡眠改善实用方法'), '疲惫', 0.85, 'problem'),
((SELECT id FROM education_resource WHERE title='睡眠改善实用方法'), '失眠', 0.82, 'problem'),
...
((SELECT id FROM education_resource WHERE title='压力下的自我关怀'), '疲惫', 0.80, 'problem'),
